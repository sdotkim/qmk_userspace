...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 [_BASE] = LAYOUT_ortho_5x14(
    ...
    XXXXXXX,       XXXXXXX,       XXXXXXX,       KC_LALT,       KC_LGUI,       TD_MABS,       KC_SPC,            KC_ENT,        TD_MADE,       META,          KC_RALT,       XXXXXXX,       XXXXXXX,       XXXXXXX \
 ),
 ...
 [_RAISE] = LAYOUT_ortho_5x14(
    ...
    XXXXXXX,       XXXXXXX,       XXXXXXX,       KC_LBRC,       KC_RBRC,       KC_LCBR,       KC_RCBR,           XXXXXXX,       XXXXXXX,       XXXXXXX,       XXXXXXX,       XXXXXXX,       XXXXXXX,       XXXXXXX \
 ),
 ...
 [_LOWER] = LAYOUT_ortho_5x14(
    ...
    XXXXXXX,       XXXXXXX,       XXXXXXX,       XXXXXXX,       XXXXXXX,       XXXXXXX,       XXXXXXX,           KC_GRV,        KC_TILD,       KC_QUOT,       KC_DQUO,       XXXXXXX,       XXXXXXX,       XXXXXXX \
 ),
